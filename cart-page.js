...
// FIXED: Auto-reload when cart updates
// ========================================

// Restaurant location (Koratagere, Karnataka)
const RESTAURANT_LOCATION = {
    lat: 13.520932123613028,
    lng: 77.23752601774017
};
...
document.getElementById('checkoutForm').addEventListener('submit', (e) => {
    ...
    alert('Order sent to WhatsApp! Please complete your payment and send the message to confirm your order.');
